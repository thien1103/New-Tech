...
const UserAccount = (props) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8000/managers/getallStudents"
      );
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <Form className="mt-10" form={form} onFinish={handleEdit}>
            <Form.Item name="name" label="Full Name">
            <Input defaultValue={editStudent.name} />
            </Form.Item>
            <Form.Item name="studentCode" label="Student Code">
            <Input defaultValue={editStudent.studentCode} />
            </Form.Item>
            <Form.Item name="email" label="Email">
            <Input defaultValue={editStudent.email} />
            </Form.Item>
            <Form.Item name="phone" label="Phone number">
            <Input defaultValue={editStudent.phone} />
            </Form.Item>
            <Form.Item name="class" label="Class">
            <Input defaultValue={editStudent.classs} />
            </Form.Item>
            <Form.Item name="birthday" label="Birthday">
            <Input defaultValue={editStudent.birthday} />
            </Form.Item>
